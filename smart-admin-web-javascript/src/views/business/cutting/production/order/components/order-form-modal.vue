<template>
  <a-modal
    :title="form.orderId ? '编辑指令单' : '新建指令单'"
    :open="visible"
    :width="860"
    :footer="null"
    @cancel="onClose"
    ...
    <a-tabs v-model:activeKey="activeTab">
      ...
      <a-tab-pane key="process" tab="流程设置">
        <a-row style="margin-bottom:8px" :gutter="8">
          <a-col><a-button @click="applyDefaultProcess">应用默认流程</a-button></a-col>
          <a-col><a-button @click="pushForward">正推</a-button></a-col>
          <a-col><a-button @click="pullBack">倒推</a-button></a-col>
          <a-col><a-button @click="clearAllTime">清除所有时间</a-button></a-col>
          <a-col><a-button type="dashed" @click="addProcess"><PlusOutlined />添加工序</a-button></a-col>
        </a-row>
